...
class Sidebar extends Component {
    ...
    getMenuClassesForResive(classes) {
    ...
    addEvents() {
        ["click", "touchstart"].forEach(event =>
            document.addEventListener(event, this.handleDoucmentClick, true)
        );
    }
    ...
    changeDefaultMenuType(e, containerClassnames) {
        e.preventDefault();
        let nextClasses = this.getMenuClassesForResive(containerClassnames);
              ...
              <div className="sidebar">
                        ...
                        >
                            <Nav vertical className="list-unstyled">
                                ...
                                className={classnames({
                                    active: ((this.state.selectedParentMenu === "garage" && this.state.viewingParentMenu==="" )|| this.state.viewingParentMenu==="garage")
                                })}
                                >
                                <NavLink
                                to="/app/garage"
                                onClick={e => this.openSubMenu(e, "garage")}
                                >
                                <i className="iconsmind-Air-Balloon" />{" "}
                                <IntlMessages id="menu.garage" />
                                </NavLink>
                            </NavItem>
                            <NavItem
                                className={classnames({
                            ...
                            <NavItem
                                className={classnames({
                                    active: ((this.state.selectedParentMenu === "third-menu" && this.state.viewingParentMenu==="" )|| this.state.viewingParentMenu==="third-menu")
                                })}
                            >
                            <NavLink
                                to="/app/third-menu"
                                onClick={e => this.openSubMenu(e, "third-menu")}
                                >
                ...
                <div className="sub-menu">
                    <div className="scroll">
                        ...
                        <Nav
                        className={classnames({
                            "d-block": ((this.state.selectedParentMenu === "garage" && this.state.viewingParentMenu==="" )|| this.state.viewingParentMenu==="garage")
                        })}
                        data-parent="garage"
                        >
                        <NavItem>
                            <NavLink to="/app/garage/start">
