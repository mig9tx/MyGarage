...
class TopNav extends Component {
    ...
    handleSarchIconClick = e => {
        if (window.innerWidth < menuHiddenBreakpoint) {
            let elem = e.target;
            if (!e.target.classList.container("search")) {
                if (e.target.parentElement.classList.container("search")) {
